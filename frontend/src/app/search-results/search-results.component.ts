...
export class SearchResultsComponent implements OnInit {
  ...
  viewDetails(destinationId: string): void {
    console.log('Navigating to details with ID:', destinationId); 
  
    if (!destinationId) {
      console.error('Invalid destination ID:', destinationId);
      return;
    }
  
    this.router.navigate(['/destination-details', destinationId]).catch((error) => {
